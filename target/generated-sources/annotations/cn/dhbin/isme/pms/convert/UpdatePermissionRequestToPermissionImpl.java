...
@Component
public class UpdatePermissionRequestToPermissionImpl implements UpdatePermissionRequestToPermission {

    @Override
    public Permission to(UpdatePermissionRequest arg0) {
        if ( arg0 == null ) {
            return null;
        }
        ...
        permission.setKeepAlive( arg0.getKeepAlive() );
